...
// firstPointName , midPointName, lastPointName , perfectAngle, goodAngle, badAngle, speech , image

  
 /*array hold all the pose with body parts and certain degree

 1-10 pose loop
         get body parts, get degree,
         draw arc, degree
         get/change gif pose
         check right.wrong
            if right
